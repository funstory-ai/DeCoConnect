...
Section.prototype.hideCommentForm = function() {
  ...
  this.$el.find('.comment-checkbox').removeAttr('checked');
};
...
module.exports = '<div class="<%= formClass %>" data-parent="<%= commentId %>">\n  <div class="author-avatar">\n    <img src="<%= currentUser.avatarUrl %>">\n  </div>\n  <p class="author-name">\n    <%= currentUser.name %>\n  </p>\n  <div class="comment-box right-of-avatar">\n    <input type="checkbox" class="comment-checkbox" id="term" name="errors" value="term">\n    <label for="term">Term</label>\n    <input type="checkbox" class="comment-checkbox" id="pronoun" name="errors" value="pronoun">\n    <label for="pronoun">Pronoun</label>\n    <input type="checkbox" class="comment-checkbox" id="adj-adv" name="errors" value="adj/adv">\n    <label for="adj-adv">Adj./Adv.</label>\n    <input type="checkbox" class="comment-checkbox" id="grammar" name="errors" value="grammar">\n    <label for="grammar">Grammar</label>\n    <input type="checkbox" class="comment-checkbox" id="bad-translation" name="errors" value="bad-translation">\n    <label for="bad-translation">Bad Translation</label>\n  </div>\n  <div class="actions right-of-avatar">\n    <a href="#" class="action-link post">Post</a>\n    <a href="#" class="action-link cancel">Cancel</a>\n  </div>\n</div>';
});
